...
[[https://cs.ualberta.ca][University of Alberta]], where I machine-learned pathfinding heuristics.
Since then, I worked on advancing the search engine at [[https://dissolve.com][Dissolve]], and today
I work in applied AI and machine learning at [[https://ibm.com][IBM]]'s Chief Data Office.
...
* Other Projects
  ...
  - [[https://github.com/riscy/a_star_on_grids][Best Practices for A\star on Grids]] :: I learned a bit about writing a good
       ...
       their existing code a bit faster, and has [[https://github.com/riscy/a_star_on_grids/tree/main/src][accompanying code in C++]].
